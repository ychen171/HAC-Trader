...
namespace HAC
{
    ...
    {
        private SystemManager06 m_Manager;
        ...
        public Form6()
        {
            ...
            price_file = new System.IO.StreamWriter("C:\\temp\\Data06.csv", true);
        ...
        private void OnSystemUpdate(double price, double qty, double min, double max, double target, double stop)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (m_Manager != null)
            {
                ...
                m_Manager.Matcher.WriteBuys("C:\\temp\\Trade Matching Algos\\buys06.csv");
                m_Manager.Matcher.WriteSells("C:\\temp\\Trade Matching Algos\\sells06.csv");
                m_Manager.Matcher.WriteRoundTurns("C:\\temp\\Trade Matching Algos\\roundturns06.csv");
